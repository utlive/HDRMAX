...
parser.add_argument("--nonlinear",help="select the nonliearity. Support 'global_logit','local_logit', 'local_m_exp','global_m_exp', 'global_exp' or 'none'.")
...
if socket.gethostname().find('tacc')>0:
    ...
    out_root_vif = join(scratch,'feats/feats_1219/hdrvifnew/vif')
    out_root_dlm = join(scratch,'feat  s/feats_1219/hdrdlmnew/dlm')
