...
if socket.gethostname().find('tacc')>0:
    ...
    out_root = '/scratch/06776/kmd1995/feats/feats/hdrvif_no_nonlinear/vif'
    out_pth = out_root
...
def vif_video_wrapper(ref_f,dis_f):
    ...
    vif_image_wrapper(ref_f,dis_f,framenos,h,w,use_adaptive_csf=False)
...
if not os.path.exists(out_pth):
    os.makedirs(out_pth)
Parallel(=3,verbose=1)(delayed(vif_refall_wrapper)(i,ref_files) for i in range(len(ref_files)))
